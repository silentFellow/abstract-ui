...
const ContentCopy = ({ styles, content, heading }: ContentCopyProps) => {
  ...
  useEffect(() => {
    setStyle({
      ...
      container: cn("full flex flex-col gap-3 bg-[#f5f5f5] dark:bg-[rgb(33,33,33)] shadow-xl p-2 rounded-lg", styles?.container || ""),
  ...
  return (
    <section className={style.container}>
      <div className={`${heading ? "justify-between gap-x-96" : "justify-end"} "w-full flex items-center"`}>
        {heading && (
